...
class FConnectionDrawingPolicy_LogicFlow : public FConnectionDrawingPolicy
{
protected:
	TWeakObjectPtr<class UEdGraph_LogicFlow> FlowGraph = nullptr;
	TMap<UEdGraphNode*, int32> NodeWidgetMap;

public:
	FConnectionDrawingPolicy_LogicFlow(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph_LogicFlow* InGraphObj);
